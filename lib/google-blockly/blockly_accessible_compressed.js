...
goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function () {
    ...
    function (a) {
        ...
        if (this.inHtmlDocument()) {
            ...
            void 0 === b ? goog.DebugLoader.IS_OLD_IE_ ? (this.oldIeWaiting_ = !0, b = " onreadystatechange='goog.debugLoader_.onScriptLoad_(this, " + ++this.lastNonModuleScriptIndex_ + ")' ", c.write('<script type="text/javascript" src="' + a + '"' + b + ">\x3c/script>")) : goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING ? this.appendScriptSrcNode_(a) : this.writeScriptSrcNode_(a) : c.write('<script type="text/javascript">' + this.protectScriptTag_(b) +
                "\x3c/script>");
            return !0
        }
        return !1
            ...
            try {
                if (goog.isDef(a))
                    ...
                    if (e[n]) c.push("*** reference loop detected (id=" + n + ") ***");
                        ...
                        c.push("{");
                        for (var p in a)
                            if (b || !goog.isFunction(a[p])) c.push("\n"), c.push(g), c.push(p +
                                " = "), f(a[p], g);
                        c.push("\n" + h + "}");
                        delete e[n]
                    }
...
goog.debug.enhanceErrorWithContext = function (a, b) {
    ...
    if (b)
        for (var c in b) goog.debug.errorcontext.addErrorContext(a, c, b[c]);
    return a
};
...
goog.events.removeAll = function (a, b) {
    ...
    for (var d in a.listeners)
        if (!b || d == b)
            for (var e = a.listeners[d].concat(), f = 0; f < e.length; ++f) goog.events.unlistenByKey(e[f]) && ++c;
    return c
};
...
Blockly.VariableMap.prototype.getVariable = function (a) {
    for (var b = Object.keys(this.variableMap_), c = 0; c < b.length; c++)
        for (var d = b[c], e = 0, f; f = this.variableMap_[d][e]; e++)
            if (Blockly.Names.equals(f.name, a)) return f;
    return null
};
...
Blockly.Workspace.prototype.deleteVariable = function (a) {
    for (var b = this.getVariableUses(a), c = 0, d; d = b[c]; c++)
        if ("procedures_defnoreturn" == d.type || "procedures_defreturn" == d.type) {
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
    ...
    }, this.bubbleGroup_), b = 2 * Blockly.Bubble.BORDER_WIDTH, Blockly.utils.createSvgElement("polygon", {
...
Blockly.DraggedConnectionManager.prototype.update = function (a, b) {
    ...
    this.wouldDeleteBlock_ = (b = !!b && !this.topBlock_.getParent() && this.topBlock_.isDeletable()) && !c;
    b && this.closestConnection_ && (this.closestConnection_.unhighlight(), this.closestConnection_ = null);
...
Blockly.utils.tokenizeInterpolation_ = function (a, b) {
    ...
    for (var f = null, g = 0; g < d.length; g++) {
        ...
        0 == e ? "%" == h ? ((h = a.join("")) && c.push(h), a.length = 0, e = 1) : a.push(h) : 1 == e ? "%" == h ? (a.push(h), e = 0) : b && "0" <= h && "9" >= h ? (e = 2, f = h, (h = a.join("")) && c.push(h), a.length = 0) : "{" == h ? e = 3 : (a.push("%", h), e = 0) : 2 == e ? "0" <= h && "9" >= h ? f += h : (c.push(parseInt(f, 10)), g--, e = 0) : 3 == e && ("" == h ? (a.splice(0, 0, "%{"), g--, e = 0) : "}" != h ? a.push(h) : (e = a.join(""), /[a-zA-Z][a-zA-Z0-9_]*/.test(e) ? (h = e.toUpperCase(),
            (h = goog.string.startsWith(h, "BKY_") ? h.substring(4) : null) && h in Blockly.utils.getMessageArray_() ? (e = Blockly.utils.getMessageArray_()[h], goog.isString(e) ? Array.prototype.push.apply(c, Blockly.utils.tokenizeInterpolation_(e, b)) : b ? c.push(String(e)) : c.push(e)) : c.push("%{" + e + "}")) : c.push("%{" + e + "}"), e = a.length = 0))
    }(h = a.join("")) && c.push(h);
    b = [];
    ...
    try {
        for (var h = 0; h < e; h++) {
            ...
            if ("block" == n || "shadow" == n && !Blockly.Events.recordUndo) {
                ...
                c.push(p.id);
                var m = parseInt(k.getAttribute("x"), 10),
                    l = parseInt(k.getAttribute("y"), 10);
...
Blockly.Xml.domToBlockHeadless_ = function (a, b) {
    ...
    c = b.newBlock(d, e);
    for (var f = null, g = 0, h; h = a.childNodes[g]; g++)
        if (3 != h.nodeType) {
            var k = null,
                n = null;
            f = 0;
            ...
            switch (h.nodeName.toLowerCase()) {
                ...
                case "field":
                    k = c.getField(f);
                    n = h.textContent;
                    if (k instanceof Blockly.FieldVariable) {
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
    function b(a) {
        if (a.isDeletable()) l = l.concat(a.getDescendants());
        else {
            a = a.getChildren();
...
Blockly.WorkspaceSvg.getContentDimensionsBounded_ = function (a, b) {
    ...
    return {
        left: f,
        top: g,
        height: Math.max(a.bottom + e, a.top + b) - g,
        width: Math.max(a.right + d, a.left + c) - f
    }
};
...
Blockly.WorkspaceSvg.prototype.getGesture = function (a) {
    var b = "mousedown" == a.type || "touchstart" == a.type,
...
Blockly.Block.prototype.setColour = function (a) {
    var b = Number(a);
    if (!isNaN(b) && 0 <= b && 360 >= b) this.hue_ = b, this.colour_ = Blockly.hueToRgb(b);
...
Blockly.BlockSvg.prototype.dispose = function (a, b) {
    if (this.workspace) {
        ...
        try {
            var e = this.getIcons();
            for (b = 0; b < e.length; b++) e[b].dispose()
        } finally {
            Blockly.Events.enable()
        }
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, n = this.getInputsInline() && !this.isCollapsed(), p = 0, m; m = b[p]; p++)
        if (m.isVisible()) {
            if (n && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT) var l = c[c.length - 1];
            else k = m.type, l = [], l.type = n &&
        ...
        if (l.thicker = !1, l.type == Blockly.BlockSvg.INLINE)
            for (b = 0; m = l[b]; b++)
    ...
    for (var c = [], d = Object.create(null), e = 0, f; f = a[e]; e++)
        if (!f.isNull()) {
            ...
            h ? f.type == Blockly.Events.MOVE ? (h.newParentId = f.newParentId, h.newInputName = f.newInputName, h.newCoordinate = f.newCoordinate) : f.type == Blockly.Events.CHANGE && f.element == h.element && f.name == h.name ? h.newValue = f.newValue : f.type != Blockly.Events.UI || "click" != f.element || "commentOpen" != h.element && "mutatorOpen" != h.element &&
                "warningOpen" != h.element ? (d[g] = f, c.push(f)) : h.newValue = f.newValue : (d[g] = f, c.push(f))
...
Blockly.Variables.allUsedVariables = function (a) {
    if (a instanceof Blockly.Block) var b = a.getDescendants();
...
Blockly.FieldVariable.prototype.setValue = function (a) {
    ...
    if (this.sourceBlock_) {
        ...
        if (d) c = d.name;
        else if (d = this.sourceBlock_.workspace.getVariable(a)) b = d.getId();
...
Blockly.FieldVariable.dropdownCreate = function () {
    ...
    if (d) {
        ...
        for (f = 0; f < a.length; f++)
            if (c && goog.string.caseInsensitiveEquals(a[f].name, b)) {
                c = !1;
                break
            }
    }
...
Blockly.VerticalFlyout.prototype.reflowInternal_ = function () {
    ...
    if (this.width_ != a) {
        ...
        if (this.RTL)
            for (c = 0; d = this.buttons_[c]; c++) b = d.getPosition().y, d.moveTo(a - d.width - this.MARGIN - Blockly.BlockSvg.TAB_WIDTH, b);
        this.width_ = a;
        this.targetWorkspace_.resize()
    }
};
...
Blockly.createDom_ = function (a, b) {
    ...
    var c = Blockly.utils.createSvgElement("defs", {}, a),
        ...
        if (!e.isDragging()) {
            ...
            if (a.contentTop < d || a.contentTop +
                ...
                for (var k = e.getTopBlocks(!1), n = 0, p; p = k[n]; n++) {
                    var m = p.getRelativeToSurfaceXY(),
                        l = p.getHeightWidth(),
                        q = d + 25 - l.height - m.y;
                    0 < q && p.moveBy(0, q);
...
blocklyApp.AudioService = ng.core.Class({
    ...
    play_: function (a, b) {
        if (this.canPlayAudio) {
            ...
            if (b) this.onEndedCallbacks_[a].push(b), this.cachedAudioFiles_[a].addEventListener("ended", b);
            else {
                var c = this;
    ...
    constructor: [function () {
        ...
        document.addEventListener("keydown", function (b) {
            var c = String(b.keyCode),
                d = a.keysToActionsOverride || a.keysToActions;
    ...
    constructor: [blocklyApp.BlockOptionsModalService, blocklyApp.KeyboardInputService, blocklyApp.AudioService, function (a, b, c) {
        ...
        this.blockOptionsModalService.registerPreShowHook(function (a, b) {
            ...
            d.keyboardInputService.addOverride("13", function (a) {
                a.preventDefault();
                a.stopPropagation(); - 1 != d.activeButtonIndex && (document.getElementById(d.getOptionId(d.activeButtonIndex)), d.activeButtonIndex < d.actionButtonsInfo.length ? d.actionButtonsInfo[d.activeButtonIndex].action() : d.dismissModal(), d.hideModal())
            });
            setTimeout(function () {
...
blocklyApp.VariableModalService = ng.core.Class({
    ...
    showRemoveModal_: function (a) {
        ...
        this.modalIsShown = !0;
        if (1 < b) this.preRemoveShowHook(a, b);
        else {
...
blocklyApp.TreeService = ng.core.Class({
    ...
    getNextFocusTargetId_: function (a) {
        for (var b = this.getAllFocusTargets_(), c = 0; c < b.length - 1; c++)
            if (b[c].id == a) return b[c + 1].id;
        return null
    },
    getPreviousFocusTargetId_: function (a) {
        for (var b = this.getAllFocusTargets_(), c = b.length - 1; 0 < c; c--)
            if (b[c].id ==
                a) return b[c - 1].id;
        return null
    },
    ...
    onKeypress: function (a, b) {
        if (!this.blockOptionsModalService.isModalShown() && !this.variableModalService.isModalShown()) {
            ...
            if (!a.altKey && !a.ctrlKey)
                if ("INPUT" == document.activeElement.tagName || "SELECT" == document.activeElement.tagName) {
                    if (9 == a.keyCode || 13 == a.keyCode || 27 == a.keyCode)
                        if (document.getElementById(b).focus(), 27 == a.keyCode ||
                ...
                if (27 == a.keyCode || 37 == a.keyCode) this.moveUpOneLevel_(b);
                else if (35 == a.keyCode)(c = this.getFinalSiblingLi_(c)) && this.setActiveDesc(c.id, b);
                else if (36 == a.keyCode)(c = this.getInitialSiblingLi_(c)) && this.setActiveDesc(c.id, b);
...
blocklyApp.ToolboxModalService = ng.core.Class({
    ...
    populateToolbox_: function () {
        ...
        var a = document.getElementById("blockly-toolbox-xml"),
            b = a.getElementsByTagName("category");
        if (b.length) this.allToolboxCategories = Array.from(b).map(function (a) {
            var b = new Blockly.Workspace,
                c = a.attributes.custom;
            ...
            return {
                categoryName: a.attributes.name.value,
                blocks: b.topBlocks_
            }
        });
        else {
    ...
    toolboxHasVariableCategory: function () {
        if (null === this.hasVariableCategory) {
            var a = document.getElementById("blockly-toolbox-xml").getElementsByTagName("category"),
                b = this;
            Array.from(a).forEach(function (a) {
                (a = a.attributes.custom) && a.value == Blockly.VARIABLE_CATEGORY_NAME && (b.hasVariableCategory = !0)
            });
        ...
        this.toolboxModalService.registerPreShowHook(function (a, b, c) {
            ...
            f.keyboardInputService.addOverride("13", function (a) {
                ...
                if (-1 != f.activeButtonIndex) {
                    ...
                    for (a = 0; a < f.toolboxCategories.length; a++)
                        if (f.firstBlockIndexes[a + 1] > f.activeButtonIndex) {
...
blocklyApp.FieldSegmentComponent = ng.core.Component({
    ...
    shouldBreakCache: function () {
        ...
        for (var b = 0; b < this.rawOptions.length; b++)
            if (a[b][0] != this.rawOptions[b][0]) return !0;
    ...
    setDropdownValue: function (a) {
        ...
        if ("NO_ACTION" != this.optionValue) {
            for (var b = void 0, c = 0; c < this.dropdownOptions.length; c++)
                if (this.dropdownOptions[c].value == a) {
...
blocklyApp.WorkspaceBlockComponent = ng.core.Component({
    ...
    getBlockDescription: function () {
        var a = this.utilsService.getBlockDescription(this.block),
            b = this.block.getSurroundParent();
